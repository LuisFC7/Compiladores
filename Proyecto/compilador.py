...
def traduccionmain():
    #Primero validación de datos
    #Primera idea validar mediante expresiones regulares y traducir(primer token y validar la sintaxis)
    #Primero abrimos archivo de código main
    ...
    with open('traduccion.cpp','w') as filename:
        ...
        for i in lineas:
            ...
            if(patron):
                filename.write(identacion+"printf()")
